...
def generate_random_emails():
    ...
    for i in range(0,110):
	 ...
	 print (pwd)
	 add_emails = ("INSERT INTO test (email,pwd) values(%s,%s)")
...
db = MySQLdb.connect("localhost","root","CogiaTest33","CogiaDB1" )
...
# create db here....
cursor.execute("create database IF NOT EXISTS CogiaDB1")
